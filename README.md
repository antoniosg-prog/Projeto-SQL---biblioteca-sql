...
- **livros**: Contém o acervo da biblioteca (id, titulo, autor_id, categoria_id, ano_publicacao, editora, isbn, quantidade_total, quantidade_disponivel).
...
```
SELECT c.nome AS Cliente, l.titulo AS Livro, e.data_devolucao_prevista
FROM emprestimos e
...
**O que você precisa:**
- Um servidor MySQL (se não tiver, o XAMPP ou o WAMP resolvem rapidinho)
